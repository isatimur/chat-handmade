const AUTH_SERVICE = "http://localhost:8762";
...
export function facebookLogin(facebookLoginRequest) {
  return request({
    url: AUTH_SERVICE + "/api/facebook/signin",
    method: "POST",
...
export function getUsers() {
  ...
  return request({
    url: AUTH_SERVICE + "/api/users/summaries",
    method: "GET",
  });
}
